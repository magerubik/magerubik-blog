 ...
 */
class RelatedPosts extends \Magerubik\Blog\Block\Post\PostList\AbstractList
{
    /**
     * @return void
     */
        ...
        $this->_postCollection
            ...
            ->setPageSize(
                (int) $this->_scopeConfig->getValue(
                    'mrblog/post_view/related_posts/number_of_posts',
    ...
    public function displayPosts()
    {
        return (bool) $this->_scopeConfig->getValue(
            'mrblog/post_view/related_posts/enabled',
            \Magento\Store\Model\ScopeInterface::SCOPE_STORE
        );
    }
    /**
