 ...
 */
namespace Magerubik\Blog\Model\ResourceModel\Category;
/**
 * Blog category collection
 */
class Collection extends \Magerubik\All\Model\ResourceModel\Abstracts\Collection
{
	/**
    ...
    {
        parent::_construct();
        $this->_init('Magerubik\Blog\Model\Category', 'Magerubik\Blog\Model\ResourceModel\Category');
    ...
    protected function _afterLoad()
    {
        ...
        if (count($items)) {
            ...
            $select = $connection->select()->from(['cps' => $this->getTable('magerubik_blog_category_store')])
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                ['store_table' => $this->getTable('magerubik_blog_category_store')],
